...
from eventkit_geonode import get_version
from eventkit_geonode.celeryapp import app  # flake8: noqa
import djcelery
...
SECRET_KEY = os.getenv('SECRET_KEY', "!-sr3-$hlz2l4c4as75g8t87g0qq7tv1ht*&_1xnd+6unmo@r)")
...
ROOT_URLCONF = os.getenv('ROOT_URLCONF', 'eventkit_geonode.urls')
...
_DEFAULT_PYSCSW = {
    ...
    'CONFIGURATION': {
        ...
        #},
        'metadata:main': {
            'identification_title': 'eventkit_geonode Catalogue',
            ...
            'identification_keywords': 'sdi,catalogue,discovery,metadata,GeoNode, eventkit_geonode',
